...
[TestClass]
public class NullTemplateTests
{
    private readonly NullTemplate _template = new();

    [TestMethod]
    public void Name_ReturnsNull()
    {
        Assert.AreEqual("null", _template.Name);
    }

    [TestMethod]
    public void GetTransformedText_GeneratesNullCheck()
    {
